...
export function PerformanceTable() {
  ...
  return (
    <div>
      ...
      {/* Add match modal */}
      {showAddMatch && (
        <div style={{ position: 'fixed', inset: 0, background: 'var(--overlay)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }} onClick={() => setShowAddMatch(false)}>
      ...
      {/* Edit match modal */}
      {editMatchTarget && (
        <div style={{ position: 'fixed', inset: 0, background: 'var(--overlay)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 150 }} onClick={() => setEditMatchTarget(null)}>
